...
(function (root, factory) {
  ...
  module.exports = factory(null, request);
...
define('scope/operator',[
  ...
  'search'
             ...
             Multimedia, Utils, Logger, search) {
  

  // Operator Scope constructor. It can be called with the parameters:

  // - ***new EVT.Operator(apiKey)** - Operator API Key string.
  // - ***new EVT.Operator(options)** - Options object should
  // contain `apiKey` and optionally operator information.*
