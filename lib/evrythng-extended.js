...
define('entity/batch',[
  ...
  return {
    ...
    resourceConstructor: function (id) {
      var resource = Resource.constructorFactory('/batches', EVT.Entity.Batch, ['task']).call(this, id);
...
define('scope/operator',[
  ...
  'search'
             ...
             Collection, Batch, Multimedia, Place, Utils, Logger, search) {
  'use strict';
...
define('scope/trustedApplication',[
  ...
  'entity/reactorLog',
  'utils'
], function (EVT, ApplicationScope, User, Thng, ActionType, Collection, ReactorLog, Utils) {
  'use strict';
