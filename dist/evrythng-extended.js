...
define('scope/operator',[
  ...
  'logger'
             ...
             Collection, Batch, Place, Utils, Logger) {
  'use strict';
  ...
  var OperatorScope = function (obj) {
    ...
    /*TODO operators should be able to read themselves - BE not implemented. simply test the api key for now.
    TODO account resource of type EVT.Account when implemented*/
    this.$init = EVT.api({
      url: '/accounts',
      authorization: this.apiKey
